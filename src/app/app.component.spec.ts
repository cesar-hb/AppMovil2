...
describe('Probar arranque de la app',() => {
  ...
  it('Se debería crear la componente foro', () =>{
  ...
  it('Se debería crear la componente miclase', () =>{
  ...
  it('Se debería crear la componente misdatos', () =>{
  ...
  it('Se debería crear la componente qr', () =>{
